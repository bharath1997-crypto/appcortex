    ...
    <form onSubmit={handleSubmit} className="space-y-5">
      ...
      <div>
        ...
        <select
          ...
          className="w-full rounded-lg bg-slate-800/60 border border-slate-700 px-4 py-3 text-sm text-slate-100 focus:outline-none focus:ring-2 focus:ring-cyan-500 transition-shadow"
        >
          {roles.map((role) => (
      ...
      <div>
        <label className="flex items-start gap-2 cursor-pointer">
          <input
            ...
            className="h-4 w-4 mt-0.5 rounded border-slate-700 bg-slate-800 text-cyan-500 focus:ring-2 focus:ring-cyan-500 focus:ring-offset-0"
          />
      ...
      <button
        type="submit"
        className="w-full rounded-full bg-gradient-to-r from-emerald-500 to-cyan-600 px-6 py-3 text-sm font-medium text-white hover:from-emerald-600 hover:to-cyan-700 transition-all shadow-lg"
      >
